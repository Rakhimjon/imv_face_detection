---
name: effective-dart
description: Applies Effective Dart guidelines in Flutter/Dart code. Use when writing or reviewing Dart code for naming conventions, types, style, imports, file structure, usage patterns, documentation, or performance.
---
...
All rules are sourced from [dart.dev/effective-dart](https://dart.dev/effective-dart).
...
- Make code **read like a sentence** when designing APIs.
- Use a **noun phrase** for non-boolean properties or variables.
- Use a **non-imperative verb phrase** for boolean properties/variables; prefer the positive form.
