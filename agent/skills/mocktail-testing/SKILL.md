...
# Mocktail Testing Skill

This skill defines how to correctly use the `mocktail` package for mocking in Dart and Flutter tests.
Sourced from [github.com/felangel/mocktail](https://github.com/felangel/mocktail).
...
| **Fake** (`extends Fake`) | Lightweight custom implementation; override only methods you need. Prefer over mocks when you don't need interaction verification. |
...
## 8. Xizmat Safari Pattern

In this project, combine mocktail with `bloc_test`:

```dart
import 'package:bloc_test/bloc_test.dart';
import 'package:mocktail/mocktail.dart';

class MockMyFacade extends Mock implements IMyFacade {}
